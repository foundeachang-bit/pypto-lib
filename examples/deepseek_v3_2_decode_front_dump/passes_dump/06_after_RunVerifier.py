...
class DeepSeekV32DecodeFront:
    ...
    def deepseek_v3_2_decode_front_layer(self, hidden_states_0: pl.Tensor[[16, 7168], pl.BFLOAT16], seq_lens_0: pl.Tensor[[16], pl.INT32], layer_id_t_0: pl.Tensor[[1], pl.INT32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], dispatch_buf_0: pl.Tensor[[128, 16, 16384], pl.BFLOAT16]) -> pl.Tensor[[128, 16, 16384], pl.BFLOAT16]:
        ...
        for b_0_out, (attn_front_iter_1_outer_l0, kv_cache_iter_1_outer_l0, pe_cache_iter_1_outer_l0) in pl.range(0, 4, 1, init_values=(attn_front_0, kv_cache_0, pe_cache_0)):
            with pl.incore():
                for b_0_in, (attn_front_iter_1_outer_l1, kv_cache_iter_1_outer_l1, pe_cache_iter_1_outer_l1) in pl.parallel(0, 4, 1, init_values=(attn_front_iter_1_outer_l0, kv_cache_iter_1_outer_l0, pe_cache_iter_1_outer_l0)):
                    ctx_len_0: pl.Scalar[pl.INT32] = pl.tensor.read(seq_lens_0, [0 + (b_0_out * 4 + b_0_in) * 1])
                    ...
                    _t18: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.tensor.view(kv_a_2, [1, 512], [0 + (b_0_out * 4 + b_0_in) * 1, 0])
                    ...
                    _t19: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(kv_a_2, [1, 64], [0 + (b_0_out * 4 + b_0_in) * 1, 512])
                    ...
                    kv_cache_3: pl.Tensor[[65536, 512], pl.BFLOAT16] = pl.tensor.assemble(kv_cache_iter_1_outer_l1, _t26, [cache_row_0, 0])
                    _t27: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.cast(pe_rot_2, target_type=pl.BFLOAT16, mode=2)
                    pe_cache_3: pl.Tensor[[65536, 64], pl.BFLOAT16] = pl.tensor.assemble(pe_cache_iter_1_outer_l1, _t27, [cache_row_0, 0])
                    ...
                    _t28: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_2, [1, 128], [0 + (b_0_out * 4 + b_0_in) * 1, q_col0_0])
                    q_nope0_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(_t28, target_type=pl.FP32, mode=2)
                    _t29: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_2, [1, 64], [0 + (b_0_out * 4 + b_0_in) * 1, q_col0_0 + 128])
                    ...
                    for h_0_out, (attn_front_iter_3_outer_l0, attn_row_iter_2_outer_l0, kk_iter_10_outer_l0, s_iter_1_outer_l0) in pl.range(0, 16, 1, init_values=(attn_front_iter_1, attn_row_1, kk_8, s_0)):
                        with pl.incore():
                            for h_0_in, (attn_front_iter_3_outer_l1, attn_row_iter_2_outer_l1, kk_iter_10_outer_l1, s_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(attn_front_iter_3_outer_l0, attn_row_iter_2_outer_l0, kk_iter_10_outer_l0, s_iter_1_outer_l0)):
                                q_col_0: pl.Scalar[pl.INDEX] = (0 + (h_0_out * 8 + h_0_in) * 1) * 192
                                _t43: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_2, [1, 128], [0 + (b_0_out * 4 + b_0_in) * 1, q_col_0])
                                q_nope_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(_t43, target_type=pl.FP32, mode=2)
                                _t44: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_2, [1, 64], [0 + (b_0_out * 4 + b_0_in) * 1, q_col_0 + 128])
                                ...
                                attn_front_5: pl.Tensor[[16, 16384], pl.FP32] = pl.tensor.assemble(attn_front_iter_3_outer_l1, attn_row_4, [0 + (b_0_out * 4 + b_0_in) * 1, 0])
                                attn_front_iter_3_outer_l1_rv, attn_row_iter_2_outer_l1_rv, kk_iter_10_outer_l1_rv, s_iter_1_outer_l1_rv = pl.yield_(attn_front_5, attn_row_4, kk_12, s_4)
                        attn_front_iter_3_outer_l0_rv, attn_row_iter_2_outer_l0_rv, kk_iter_10_outer_l0_rv, s_iter_1_outer_l0_rv = pl.yield_(attn_front_iter_3_outer_l1_rv, attn_row_iter_2_outer_l1_rv, kk_iter_10_outer_l1_rv, s_iter_1_outer_l1_rv)
                    attn_front_iter_1_outer_l1_rv, kv_cache_iter_1_outer_l1_rv, pe_cache_iter_1_outer_l1_rv = pl.yield_(attn_front_iter_3_outer_l0_rv, kv_cache_3, pe_cache_3)
            attn_front_iter_1_outer_l0_rv, kv_cache_iter_1_outer_l0_rv, pe_cache_iter_1_outer_l0_rv = pl.yield_(attn_front_iter_1_outer_l1_rv, kv_cache_iter_1_outer_l1_rv, pe_cache_iter_1_outer_l1_rv)
        for b_1_out, (dispatch_buf_iter_1_outer_l0,) in pl.range(0, 4, 1, init_values=(dispatch_buf_0,)):
            with pl.incore():
                for b_1_in, (dispatch_buf_iter_1_outer_l1,) in pl.parallel(0, 4, 1, init_values=(dispatch_buf_iter_1_outer_l0,)):
                    target_node_0: pl.Scalar[pl.INDEX] = (0 + (b_1_out * 4 + b_1_in) * 1 + pl.cast(layer_id_0, pl.INDEX)) % 128
                    _t66: pl.Tensor[[1, 16384], pl.FP32] = pl.tensor.view(attn_front_iter_1_outer_l0_rv, [1, 16384], [0 + (b_1_out * 4 + b_1_in) * 1, 0])
                    token_row_0: pl.Tensor[[1, 16384], pl.BFLOAT16] = pl.tensor.cast(_t66, target_type=pl.BFLOAT16, mode=2)
                    dispatch_buf_3: pl.Tensor[[128, 16, 16384], pl.BFLOAT16] = pl.tensor.assemble(dispatch_buf_iter_1_outer_l1, token_row_0, [target_node_0, 0 + (b_1_out * 4 + b_1_in) * 1, 0])
                    dispatch_buf_iter_1_outer_l1_rv: pl.Tensor[[128, 16, 16384], pl.BFLOAT16] = pl.yield_(dispatch_buf_3)
            dispatch_buf_iter_1_outer_l0_rv: pl.Tensor[[128, 16, 16384], pl.BFLOAT16] = pl.yield_(dispatch_buf_iter_1_outer_l1_rv)

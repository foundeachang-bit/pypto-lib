...
class DeepSeekV32PrefillFront:
    ...
    def deepseek_v3_2_prefill_front_layer(self, hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], seq_lens_0: pl.Tensor[[16], pl.INT32], layer_id_t_0: pl.Tensor[[1], pl.INT32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], dispatch_buf_0: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16]) -> pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16]:
        with pl.auto_incore():
            ...
            for b_0_out, (dispatch_buf_iter_1_outer, kv_cache_iter_1_outer, pe_cache_iter_1_outer) in pl.range(0, 4, 1, init_values=(dispatch_buf_0, kv_cache_0, pe_cache_0)):
                for b_0_in, (dispatch_buf_iter_1_inner, kv_cache_iter_1_inner, pe_cache_iter_1_inner) in pl.parallel(0, 4, 1, init_values=(dispatch_buf_iter_1_outer, kv_cache_iter_1_outer, pe_cache_iter_1_outer)):
                    ...
                    for p0_idx_0, (dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(dispatch_buf_iter_1_inner, kv_cache_iter_1_inner, pe_cache_iter_1_inner)):
                    ...
                    dispatch_buf_iter_1_inner_rv, kv_cache_iter_1_inner_rv, pe_cache_iter_1_inner_rv = pl.yield_(dispatch_buf_4, kv_cache_4, pe_cache_4)
                dispatch_buf_iter_1_outer_rv, kv_cache_iter_1_outer_rv, pe_cache_iter_1_outer_rv = pl.yield_(dispatch_buf_iter_1_inner_rv, kv_cache_iter_1_inner_rv, pe_cache_iter_1_inner_rv)

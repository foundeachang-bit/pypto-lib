...
class DeepSeekV32PrefillFront:
    ...
    def deepseek_v3_2_prefill_front_layer(self, hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], seq_lens_0: pl.Tensor[[16], pl.INT32], layer_id_t_0: pl.Tensor[[1], pl.INT32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], dispatch_buf_0: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16]) -> pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16]:
        ...
        for b_0_out, (dispatch_buf_iter_1_outer_l0, kv_cache_iter_1_outer_l0, pe_cache_iter_1_outer_l0) in pl.range(0, 4, 1, init_values=(dispatch_buf_0, kv_cache_0, pe_cache_0)):
            ...
            dispatch_buf_iter_1_outer_l1_rv: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16] = ret[0]
            kv_cache_iter_1_outer_l1_rv: pl.Tensor[[65536, 512], pl.BFLOAT16] = ret[1]
            pe_cache_iter_1_outer_l1_rv: pl.Tensor[[65536, 64], pl.BFLOAT16] = ret[2]
    ...
    def deepseek_v3_2_prefill_front_layer_incore_0_aic(self, b_0_out: pl.Scalar[pl.INDEX], dispatch_buf_0: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16], dispatch_buf_iter_1_outer_l0: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16], hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], k0_2: pl.Scalar[pl.INDEX], kb_2: pl.Scalar[pl.INDEX], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], kv_cache_iter_1_outer_l0: pl.Tensor[[65536, 512], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], layer_id_0: pl.Scalar[pl.INT32], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], pe_cache_iter_1_outer_l0: pl.Tensor[[65536, 64], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], seq_lens_0: pl.Tensor[[16], pl.INT32], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], x_chunk_2: pl.Tensor[[4, 512], pl.FP32]) -> tuple[pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16], pl.Tensor[[65536, 512], pl.BFLOAT16], pl.Tensor[[65536, 64], pl.BFLOAT16]]:
            ...
            for p0_idx_0, (dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(dispatch_buf_iter_1_outer_l1, kv_cache_iter_1_outer_l1, pe_cache_iter_1_outer_l1)):
                ...
                for ob_1_rem, (k0_iter_6_rem, kb_iter_4_rem, x_chunk_iter_6_rem) in pl.parallel(0, 5, 1, init_values=(k0_2, kb_2, x_chunk_2)):
                    ...
                    for kb_6, (k0_iter_8, x_chunk_iter_8) in pl.range(0, 14, 1, init_values=(k0_iter_6_rem, x_chunk_iter_6_rem)):
                        ...
                        wkv_chunk_0__h0: pl.Tensor[[256, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                        wkv_chunk_0__h1: pl.Tensor[[256, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                        wkv_chunk_0__tmp: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.create(__list__(512, 128), dtype=pl.BFLOAT16)
                        wkv_chunk_0__mid: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.assemble(wkv_chunk_0__tmp, wkv_chunk_0__h0, __list__(0, 0))
                        pl.comm.tfree_to_aiv(0)
                        wkv_chunk_0: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.assemble(wkv_chunk_0__mid, wkv_chunk_0__h1, __list__(256, 0))
                        pl.comm.tfree_to_aiv(1)
                        _t14: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                        _t14__discard: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                        _t15: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.matmul(_t14, wkv_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                        pl.comm.tfree_to_aiv(0)
                        __half0__: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.tensor.view(_t15, __list__(2, 128), __list__(0, 0))
                        __half1__: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.tensor.view(_t15, __list__(2, 128), __list__(2, 0))
                ...
                for ti_0, (dispatch_buf_iter_5, kv_cache_iter_5, pe_cache_iter_5) in pl.range(0, valid_tok_0, 1, init_values=(dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3)):
                    ...
                    _t35: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv()
                    _t36__h0: pl.Tensor[[64, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                    _t36__h1: pl.Tensor[[64, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                    _t36__tmp: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.create(__list__(128, 512), dtype=pl.BFLOAT16)
                    _t36__mid: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.assemble(_t36__tmp, _t36__h0, __list__(0, 0))
                    pl.comm.tfree_to_aiv(0)
                    _t36: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.assemble(_t36__mid, _t36__h1, __list__(64, 0))
                    pl.comm.tfree_to_aiv(1)
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_front_layer_incore_0_aiv(self, b_0_out: pl.Scalar[pl.INDEX], dispatch_buf_0: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16], dispatch_buf_iter_1_outer_l0: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16], hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], k0_2: pl.Scalar[pl.INDEX], kb_2: pl.Scalar[pl.INDEX], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], kv_cache_iter_1_outer_l0: pl.Tensor[[65536, 512], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], layer_id_0: pl.Scalar[pl.INT32], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], pe_cache_iter_1_outer_l0: pl.Tensor[[65536, 64], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], seq_lens_0: pl.Tensor[[16], pl.INT32], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], x_chunk_2: pl.Tensor[[4, 512], pl.FP32], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16], pl.Tensor[[65536, 512], pl.BFLOAT16], pl.Tensor[[65536, 64], pl.BFLOAT16]]:
        ...
        for b_0_in, (dispatch_buf_iter_1_outer_l1, kv_cache_iter_1_outer_l1, pe_cache_iter_1_outer_l1) in pl.parallel(0, 4, 1, init_values=(dispatch_buf_iter_1_outer_l0, kv_cache_iter_1_outer_l0, pe_cache_iter_1_outer_l0)):
            ...
            for p0_idx_0, (dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(dispatch_buf_iter_1_outer_l1, kv_cache_iter_1_outer_l1, pe_cache_iter_1_outer_l1)):
                ...
                for kb_0, (sq_sum_iter_2,) in pl.range(0, 14, 1, init_values=(sq_sum_1,)):
                    k0_0: pl.Scalar[pl.INDEX] = kb_0 * 512
                    _t0: pl.Tensor[[2, 512], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [2, 512], [0 + (b_0_out * 4 + b_0_in) * 1 + AIV_IDX * 2, p0_0, k0_0])
                    x_chunk_0: pl.Tensor[[2, 512], pl.FP32] = pl.tensor.cast(_t0, target_type=pl.FP32, mode=2)
                    _t1: pl.Tensor[[2, 512], pl.FP32] = pl.tensor.mul(x_chunk_0, x_chunk_0)
                ...
                q_proj_tile_0: pl.Tensor[[2, 128 * 192], pl.BFLOAT16] = pl.tensor.create([2, 128 * 192], dtype=pl.BFLOAT16)
                kv_a_tile_0: pl.Tensor[[2, 576], pl.BFLOAT16] = pl.tensor.create([2, 576], dtype=pl.BFLOAT16)
                ...
                for ob_1_rem, (k0_iter_6_rem, kb_iter_4_rem, kv_a_tile_iter_1_rem, x_chunk_iter_6_rem) in pl.parallel(0, 5, 1, init_values=(k0_2, kb_2, kv_a_tile_0, x_chunk_2)):
                    kv0_0: pl.Scalar[pl.INDEX] = (0 + ob_1_rem * 1) * 128
                    kv_acc_0: pl.Tensor[[2, 128], pl.FP32] = pl.tensor.create([2, 128], dtype=pl.FP32)
                    ...
                    for kb_6, (k0_iter_8, kv_acc_iter_2, x_chunk_iter_8) in pl.range(0, 14, 1, init_values=(k0_iter_6_rem, kv_acc_1, x_chunk_iter_6_rem)):
                        k0_10: pl.Scalar[pl.INDEX] = kb_6 * 512
                        _t12: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [4, 512], [0 + (b_0_out * 4 + b_0_in) * 1, p0_0, k0_10])
                        ...
                        wkv_chunk_0: pl.Tensor[[256, 128], pl.BFLOAT16] = pl.tensor.view(wkv_a_0, [256, 128], [k0_10 + AIV_IDX * 256, kv0_0])
                        ...
                        _t15: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
                        kv_acc_4: pl.Tensor[[2, 128], pl.FP32] = pl.tensor.add(kv_acc_iter_2, _t15)
                        pl.comm.tfree_to_aic(AIV_IDX)
                        k0_9, kv_acc_3, x_chunk_9 = pl.yield_(k0_10, kv_acc_4, normed_5, x_chunk_10)
                    _t16: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.tensor.cast(kv_acc_3, target_type=pl.BFLOAT16, mode=2)
                    kv_a_tile_3: pl.Tensor[[4, 576], pl.BFLOAT16] = pl.tensor.assemble(kv_a_tile_iter_1_rem, _t16, [0 + AIV_IDX * 2, kv0_0])
                ...
                attn_tile_0: pl.Tensor[[2, 16384], pl.FP32] = pl.tensor.create([2, 16384], dtype=pl.FP32)
                ...
                for ti_0, (attn_tile_iter_2, dispatch_buf_iter_5, kv_cache_iter_5, pe_cache_iter_5) in pl.range(0, valid_tok_0, 1, init_values=(attn_tile_1, dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3)):
                    pos_0: pl.Scalar[pl.INDEX] = p0_0 + ti_0
                    ctx_len_0: pl.Scalar[pl.INDEX] = pos_0 + 1
                    cos_row_0: pl.Tensor[[1, 32], pl.FP32] = pl.tensor.view(rope_cos_0, [1, 32], [pos_0, 0 + AIV_IDX * 32])
                    sin_row_0: pl.Tensor[[1, 32], pl.FP32] = pl.tensor.view(rope_sin_0, [1, 32], [pos_0, 0 + AIV_IDX * 32])
                    cos_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(cos_row_0, [1, 64 // 2], [0, 0])
                    cos_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(cos_row_0, [1, 64 // 2], [0, 64 // 2])
                    sin_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(sin_row_0, [1, 64 // 2], [0, 0])
                    sin_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(sin_row_0, [1, 64 // 2], [0, 64 // 2])
                    cache_row_0: pl.Scalar[pl.INDEX] = (0 + (b_0_out * 4 + b_0_in) * 1) * 4096 + pos_0
                    _t17: pl.Tensor[[1, 256], pl.BFLOAT16] = pl.tensor.deep_view(kv_a_tile_iter_1_rem_rv, [1, 256], [ti_0, 0])
                    kv_row_0: pl.Tensor[[1, 256], pl.FP32] = pl.tensor.cast(_t17, target_type=pl.FP32, mode=2)
                    kv_gamma_0: pl.Tensor[[1, 256], pl.FP32] = pl.tensor.view(kv_norm_weight_0, [1, 256], [0, 0 + AIV_IDX * 256])
                    kv_normed_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.col_expand_mul(kv_row_0, kv_gamma_0)
                    _t18: pl.Tensor[[1, 32], pl.BFLOAT16] = pl.tensor.deep_view(kv_a_tile_iter_1_rem_rv, [1, 32], [ti_0, 512])
                    pe_row_0: pl.Tensor[[1, 32], pl.FP32] = pl.tensor.cast(_t18, target_type=pl.FP32, mode=2)
                    pe_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(pe_row_0, [1, 64 // 2], [0, 0])
                    pe_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(pe_row_0, [1, 64 // 2], [0, 64 // 2])
                    ...
                    _t25: pl.Tensor[[1, 256], pl.BFLOAT16] = pl.tensor.cast(kv_normed_0, target_type=pl.BFLOAT16, mode=2)
                    kv_cache_7: pl.Tensor[[65536, 512], pl.BFLOAT16] = pl.tensor.assemble(kv_cache_iter_5, _t25, [cache_row_0, 0 + AIV_IDX * 256])
                    ...
                    topk_vals_0: pl.Tensor[[1, 1024], pl.FP32] = pl.tensor.create([1, 1024], dtype=pl.FP32)
                    topk_idx_0: pl.Tensor[[1, 1024], pl.INT32] = pl.tensor.create([1, 1024], dtype=pl.INT32)
                    blk_topk_vals_0: pl.Tensor[[1, 2048], pl.FP32] = pl.tensor.create([1, 2048], dtype=pl.FP32)
                    blk_topk_idx_0: pl.Tensor[[1, 2048], pl.INT32] = pl.tensor.create([1, 2048], dtype=pl.INT32)
                    ...
                    q_col0_0: pl.Scalar[pl.INDEX] = 0
                    _t27: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.deep_view(q_proj_tile_iter_1_outer_l0_rv, [1, 64], [ti_0, q_col0_0])
                    q_nope0_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(_t27, target_type=pl.FP32, mode=2)
                    _t28: pl.Tensor[[1, 32], pl.BFLOAT16] = pl.tensor.deep_view(q_proj_tile_iter_1_outer_l0_rv, [1, 32], [ti_0, q_col0_0 + 128])
                    q_pe0_0: pl.Tensor[[1, 32], pl.FP32] = pl.tensor.cast(_t28, target_type=pl.FP32, mode=2)
                    q0_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(q_pe0_0, [1, 64 // 2], [0, 0])
                    q0_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32] = pl.tensor.deep_view(q_pe0_0, [1, 64 // 2], [0, 64 // 2])
                    ...
                    _t35: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.cast(q_nope0_0, target_type=pl.BFLOAT16, mode=2)
                    pl.comm.tpush_to_aic(_t35, AIV_IDX)
                    _t36: pl.Tensor[[64, 512], pl.BFLOAT16] = pl.tensor.view(w_q_nope_to_latent_0, [64, 512], [0 + AIV_IDX * 64, 0, 0])
                    pl.comm.tpush_to_aic(_t36, AIV_IDX)
                    q0_nope_latent_0: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.comm.tpop_from_aic()
                    sparse_k_gen_0: pl.Scalar[pl.INDEX] = min(2048, ctx_len_0)
                    for blk_0, (blk_topk_idx_iter_6, blk_topk_vals_iter_2, kk_iter_1) in pl.range(0, 2, 1, init_values=(blk_topk_idx_3, blk_topk_vals_1, kk_0)):
                        ...
                        for ss_0, (blk_topk_idx_iter_8, blk_topk_vals_iter_4, kk_iter_3) in pl.range(0, 2048, 1, init_values=(blk_topk_idx_iter_6, blk_topk_vals_iter_2, kk_iter_1)):
                            ...
                            if s_0 < blk_end_0:
                                cache_s_0: pl.Scalar[pl.INDEX] = (0 + (b_0_out * 4 + b_0_in) * 1) * 4096 + s_0
                                _t37: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.tensor.deep_view(kv_cache_7, [1, 512], [cache_s_0, 0])
                                kv_s_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(_t37, target_type=pl.FP32, mode=2)
                                _t38: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.deep_view(pe_cache_7, [1, 64], [cache_s_0, 0])
                    ...
                    attn_row_0: pl.Tensor[[1, 8192], pl.FP32] = pl.tensor.create([1, 8192], dtype=pl.FP32)
                    ...
                    for ti_1, (dispatch_buf_iter_7, pos_iter_1) in pl.range(0, valid_tok_0, 1, init_values=(dispatch_buf_iter_5, pos_0)):
                        pos_3: pl.Scalar[pl.INDEX] = p0_0 + ti_1
                        target_node_0: pl.Scalar[pl.INDEX] = (0 + (b_0_out * 4 + b_0_in) * 1 + pos_3 + pl.cast(layer_id_0, pl.INDEX)) % 128
                        _t65: pl.Tensor[[1, 8192], pl.FP32] = pl.tensor.deep_view(attn_tile_4, [1, 8192], [ti_1, 0])
                        token_row_0: pl.Tensor[[1, 8192], pl.BFLOAT16] = pl.tensor.cast(_t65, target_type=pl.BFLOAT16, mode=2)
                        dispatch_buf_9: pl.Tensor[[128, 16, 4096, 16384], pl.BFLOAT16] = pl.tensor.assemble(dispatch_buf_iter_7, token_row_0, [target_node_0, 0 + (b_0_out * 4 + b_0_in) * 1 + AIV_IDX * 8192, pos_3, 0])
    ...
    def deepseek_v3_2_prefill_front_layer_incore_0_incore_0_aiv(self, b_0_in: pl.Scalar[pl.INDEX], b_0_out: pl.Scalar[pl.INDEX], hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], inv_rms_1: pl.Tensor[[4, 1], pl.FP32], k0_0: pl.Scalar[pl.INDEX], k0_iter_1_outer_l0: pl.Scalar[pl.INDEX], kb_0: pl.Scalar[pl.INDEX], kb_iter_1_outer_l0: pl.Scalar[pl.INDEX], ob_0_out: pl.Scalar[pl.INDEX], p0_0: pl.Scalar[pl.INDEX], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], q_proj_tile_0: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], q_proj_tile_iter_1_outer_l0: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], x_chunk_0: pl.Tensor[[4, 512], pl.FP32], x_chunk_iter_1_outer_l0: pl.Tensor[[4, 512], pl.FP32], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[4, 128 * 192], pl.BFLOAT16], pl.Tensor[[4, 512], pl.FP32]]:
        ...
        for ob_0_in, (k0_iter_1_outer_l1, kb_iter_1_outer_l1, q_proj_tile_iter_1_outer_l1, x_chunk_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(k0_iter_1_outer_l0, kb_iter_1_outer_l0, q_proj_tile_iter_1_outer_l0, x_chunk_iter_1_outer_l0)):
            ...
            for kb_3, (k0_iter_3, q_acc_iter_2, x_chunk_iter_3) in pl.range(0, 14, 1, init_values=(k0_iter_1_outer_l1, q_acc_1, x_chunk_iter_1_outer_l1)):
                k0_5: pl.Scalar[pl.INDEX] = kb_3 * 512
                _t6: pl.Tensor[[4, 256], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [4, 256], [0 + (b_0_out * 4 + b_0_in) * 1, p0_0 + AIV_IDX * 256, k0_5])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_front_layer_incore_0_incore_1_aic(self, attn_row_1: pl.Tensor[[1, 16384], pl.FP32], attn_row_iter_2_outer_l0: pl.Tensor[[1, 16384], pl.FP32], b_0_in: pl.Scalar[pl.INDEX], b_0_out: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32], ctx_len_0: pl.Scalar[pl.INDEX], h_0_out: pl.Scalar[pl.INDEX], kk_8: pl.Scalar[pl.INDEX], kk_iter_10_outer_l0: pl.Scalar[pl.INDEX], kv_cache_7: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_7: pl.Tensor[[65536, 64], pl.BFLOAT16], q_proj_tile_iter_1_outer_l0_rv: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], s_0: pl.Scalar[pl.INDEX], s_iter_1_outer_l0: pl.Scalar[pl.INDEX], sin_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32], ti_0: pl.Scalar[pl.INDEX], topk_idx_6: pl.Tensor[[1, 2048], pl.INDEX], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16]) -> tuple[pl.Tensor[[1, 16384], pl.FP32], pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX]]:
        pl.comm.aic_initialize_pipe()

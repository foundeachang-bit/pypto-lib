...
class DeepSeekV32DecodeBack:
    ...
    def deepseek_v3_2_decode_back_layer_incore_0(self, b_0_out: pl.Scalar[pl.INDEX], combine_buf_0: pl.Tensor[[128, 16, 16384], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 67108864, 0)], combined_0: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 1)], combined_iter_1_outer_l0: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 2)], node_id_0: pl.Scalar[pl.INT32]) -> pl.Tensor[[16, 16384], pl.FP32]:
        for b_0_in, (combined_iter_1_outer_l1,) in pl.parallel(0, 4, 1, init_values=(combined_iter_1_outer_l0,)):
            _t0: pl.Tensor[[1, 16384], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 32768, 3)] = pl.tensor.view(combine_buf_0, [1, 16384], [node_id_0, 0 + (b_0_out * 4 + b_0_in) * 1, 0])
            row_0: pl.Tensor[[1, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 65536, 4)] = pl.tensor.cast(_t0, target_type=pl.FP32, mode=2)
            combined_3: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 5)] = pl.tensor.assemble(combined_iter_1_outer_l1, row_0, [0 + (b_0_out * 4 + b_0_in) * 1, 0])
            combined_iter_1_outer_l1_rv: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 6)] = pl.yield_(combined_3)
        return combined_iter_1_outer_l1_rv
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_decode_back_layer_incore_3(self, b0_0: pl.Scalar[pl.INDEX], down_proj_tile_3: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 0)], o0_2: pl.Scalar[pl.INDEX], o0_iter_4_outer_l0: pl.Scalar[pl.INDEX], ob_2_out: pl.Scalar[pl.INDEX], out_0: pl.Tensor[[16, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 229376, 1)], out_iter_1: pl.Tensor[[16, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 229376, 2)], out_iter_3_outer_l0: pl.Tensor[[16, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 229376, 3)], resid1_tile_iter_1_outer_l0_rv: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 4)]) -> tuple[pl.Scalar[pl.INDEX], pl.Tensor[[16, 7168], pl.BFLOAT16]]:
    ...
    def deepseek_v3_2_decode_back_layer(self, hidden_states_0: pl.Tensor[[16, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 229376, 0)], node_id_t_0: pl.Tensor[[1], pl.INT32, pl.MemRef(pl.MemorySpace.DDR, -1, 4, 1)], combine_buf_0: pl.Tensor[[128, 16, 16384], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 67108864, 2)], wo_0: pl.Tensor[[16384, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 234881024, 3)], post_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 28672, 4)], w_gate_0: pl.Tensor[[7168, 18432], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 264241152, 5)], w_up_0: pl.Tensor[[7168, 18432], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 264241152, 6)], w_down_0: pl.Tensor[[18432, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 264241152, 7)], out_0: pl.Tensor[[16, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 229376, 8)]) -> pl.Tensor[[16, 7168], pl.BFLOAT16]:
        ...
        for b_0_out, (combined_iter_1_outer_l0,) in pl.range(0, 4, 1, init_values=(combined_0,)):
            combined_iter_1_outer_l1_rv: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 10)] = self.deepseek_v3_2_decode_back_layer_incore_0(b_0_out, combine_buf_0, combined_0, combined_iter_1_outer_l0, node_id_0)
            combined_iter_1_outer_l0_rv: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 11)] = pl.yield_(combined_iter_1_outer_l1_rv)
        for b0_0, (out_iter_1,) in pl.range(0, 16, 4, init_values=(out_0,)):
            ...
            for ob_0_out, (resid1_tile_iter_1_outer_l0,) in pl.range(0, 7, 1, init_values=(resid1_tile_0,)):
                resid1_tile_iter_1_outer_l1_rv: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 13)] = self.call_group(deepseek_v3_2_decode_back_layer_incore_1_group, b0_0, combined_iter_1_outer_l0_rv, hidden_states_0, ob_0_out, resid1_tile_0, resid1_tile_iter_1_outer_l0, wo_0)
            ...
            for ob_1, (down_proj_tile_iter_2, k0_iter_7, kb_iter_3, o0_iter_1) in pl.range(0, 36, 1, init_values=(down_proj_tile_1, k0_5, kb_2, o0_0)):
                ...
                for dob_0_out, (down_proj_tile_iter_4_outer_l0,) in pl.range(0, 7, 1, init_values=(down_proj_tile_iter_2,)):
                    down_proj_tile_iter_4_outer_l1_rv: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 56)] = self.call_group(deepseek_v3_2_decode_back_layer_incore_2_group, dob_0_out, down_proj_tile_1, down_proj_tile_iter_2, down_proj_tile_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0)
    ...
    def deepseek_v3_2_decode_back_layer_incore_1_aiv(self, b0_0: pl.Scalar[pl.INDEX], combined_iter_1_outer_l0_rv: pl.Tensor[[16, 16384], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 1048576, 0)], hidden_states_0: pl.Tensor[[16, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 229376, 1)], ob_0_out: pl.Scalar[pl.INDEX], resid1_tile_0: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 2)], resid1_tile_iter_1_outer_l0: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 3)], wo_0: pl.Tensor[[16384, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 234881024, 4)], AIV_IDX: pl.Scalar[pl.INDEX]) -> pl.Tensor[[4, 7168], pl.FP32]:
        ...
        for ob_0_in, (resid1_tile_iter_1_outer_l1,) in pl.parallel(0, 8, 1, init_values=(resid1_tile_iter_1_outer_l0,)):
            ...
            for kb_0, (o_acc_iter_2,) in pl.range(0, 32, 1, init_values=(o_acc_1,)):
                k0_0: pl.Scalar[pl.INDEX] = kb_0 * 512
                _t1: pl.Tensor[[2, 512], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 4096, 8)] = pl.tensor.view(combined_iter_1_outer_l0_rv, [2, 512], [b0_0 + AIV_IDX * 2, k0_0])
    ...
    class deepseek_v3_2_decode_back_layer_incore_1_group:
        """Parameter passing:
          call_group(deepseek_v3_2_decode_back_layer_incore_1_group, b0_0, combined_iter_1_outer_l0_rv, hidden_states_0, ob_0_out, resid1_tile_0, resid1_tile_iter_1_outer_l0, wo_0)
            → deepseek_v3_2_decode_back_layer_incore_1_aic(b0_0, combined_iter_1_outer_l0_rv, hidden_states_0, ob_0_out, resid1_tile_0, resid1_tile_iter_1_outer_l0, wo_0)
            → deepseek_v3_2_decode_back_layer_incore_1_aiv(b0_0, combined_iter_1_outer_l0_rv, hidden_states_0, ob_0_out, resid1_tile_0, resid1_tile_iter_1_outer_l0, wo_0, AIV_IDX=<runtime>)
        """
        pass

    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_decode_back_layer_incore_2_aic(self, dob_0_out: pl.Scalar[pl.INDEX], down_proj_tile_1: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 0)], down_proj_tile_iter_2: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 1)], down_proj_tile_iter_4_outer_l0: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 2)], mlp_chunk_bf16_0: pl.Tensor[[4, 512], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 4096, 3)], o0_3: pl.Scalar[pl.INDEX], w_down_0: pl.Tensor[[18432, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 264241152, 4)]) -> pl.Tensor[[4, 7168], pl.FP32]:
        pl.comm.aic_initialize_pipe()
    ...
    def deepseek_v3_2_decode_back_layer_incore_2_aiv(self, dob_0_out: pl.Scalar[pl.INDEX], down_proj_tile_1: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 0)], down_proj_tile_iter_2: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 1)], down_proj_tile_iter_4_outer_l0: pl.Tensor[[4, 7168], pl.FP32, pl.MemRef(pl.MemorySpace.DDR, -1, 114688, 2)], mlp_chunk_bf16_0: pl.Tensor[[4, 512], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 4096, 3)], o0_3: pl.Scalar[pl.INDEX], w_down_0: pl.Tensor[[18432, 7168], pl.BFLOAT16, pl.MemRef(pl.MemorySpace.DDR, -1, 264241152, 4)], AIV_IDX: pl.Scalar[pl.INDEX]) -> pl.Tensor[[4, 7168], pl.FP32]:
        ...
        return down_proj_tile_iter_4_outer_l1_rv
    @pl.function_group(aic="deepseek_v3_2_decode_back_layer_incore_2_aic", aiv="deepseek_v3_2_decode_back_layer_incore_2_aiv", aiv_runtime_params=["AIV_IDX"])
    class deepseek_v3_2_decode_back_layer_incore_2_group:
        """Parameter passing:
          call_group(deepseek_v3_2_decode_back_layer_incore_2_group, dob_0_out, down_proj_tile_1, down_proj_tile_iter_2, down_proj_tile_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0)
            → deepseek_v3_2_decode_back_layer_incore_2_aic(dob_0_out, down_proj_tile_1, down_proj_tile_iter_2, down_proj_tile_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0)
            → deepseek_v3_2_decode_back_layer_incore_2_aiv(dob_0_out, down_proj_tile_1, down_proj_tile_iter_2, down_proj_tile_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0, AIV_IDX=<runtime>)
        """
        pass
